...
6. Clone this repository:
   #+begin_src bash
   cd /mnt/home
   git clone https://github.com/joshuablais/nixos-config.git
   #+end_src
...
* Roadmap
** TODO Integrate ZRAM for swap
** TODO Impermanance
** TODO Disko for all machines
** TODO Attic binary Cache on Logos
** TODO Forgjo worker on server for builds and shipping closures
** TODO Bring server architecture into repo

** IDEA Dendritic configuration?
