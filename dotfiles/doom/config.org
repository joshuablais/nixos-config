...
#+end_src
** Clipboard Manager
Use emacs as a clipboard manager - search the killring and add to your system clipboard 
...
#+end_src
** Shell
Allows instant search of previous shell commands and running async/regular/eshell
